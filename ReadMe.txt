...
3. Depending on the choice of operation it will ask you for phi if you have choosen remainders because we want to remove all that doesn't entail phi, or not phi if you have choosen resolution. 

4. If you choose to enter your own KB it will ask you to enter your own phi. But if you choose an example as your KB you can choose to use a premade example or your phi. 
5. It will then do the choosen operation with KB and phi and give you the result. 
